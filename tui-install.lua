...
local files = {
  {
    name = "tui-install",
    url = "https://raw.github.com/Forte40/tui/"..branch.."/tui-install.lua"
  },
  {
    name = "tui",
    url = "https://raw.github.com/Forte40/tui/"..branch.."/tui.lua"
  },
  {
    name = "calc",
    url = "https://raw.github.com/Forte40/tui/"..branch.."/examples/calculator.lua"
  }
}
